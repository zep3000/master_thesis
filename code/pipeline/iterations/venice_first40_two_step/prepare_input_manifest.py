#!/usr/bin/env python3
"""Create the frozen first-40 manifest without annotation or prior-model fields."""
...
OUTPUT = SCRIPT_DIR / "input_manifest_first40.json"
...
def main() -> int:
    ...
    images = []
    for index, item in enumerate(source["images"][:40]):
    ...
    payload = {
        "schema_version": "qwen_venice_first40_two_step_input_manifest_v1",
        "task_id": "venice_first40_two_step",
        "selection": "first_40_in_source_order",
