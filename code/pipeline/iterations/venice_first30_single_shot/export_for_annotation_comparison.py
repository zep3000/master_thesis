#!/usr/bin/env python3
"""Convert the completed Venice first-30 run to comparison-app JSONL."""
...
MASTER_ROOT = HERE.parent.parent
DEFAULT_INPUT = HERE / "output" / "venice_first30_single_shot.completed.jsonl"
DEFAULT_OUTPUT = (
    MASTER_ROOT
    / "openrouter_qwen"
    / "output"
    / "qwen35_9b_venice_first30_single_shot_full_annotation.jsonl"
)
...
def convert_record(record: dict[str, Any], annotation: dict[str, Any]) -> dict[str, Any]:
    converted_annotation = {
        "schema_version": "ad_face_annotation_v2_comparison_from_venice_first30",
        ...
        "machine_annotation": {
            ...
            "source": "qwen_iteration/venice_first30_single_shot",
        },
    }
    return {
        "image_id": record.get("image_id"),
        ...
        "source_record_schema": "qwen_venice_first30_comparison_jsonl_v1",
